...
import { formatPromptRecommendations, recommendPrompts } from '../ai/prompt-recommendations'
...
export const handlePromptCommand = async (event: GenericMessageEvent) => {
  try {
    ...
    // Format and post the recommendations
    const recommendationsText = formatPromptRecommendations(recommendations)
